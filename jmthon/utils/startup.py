    ...
    if not log_chat:
        ...
        try:
            group_id = await jmubot(
                CreateChannelRequest(
                    title="مجموعة الحفظ isco",
                    about="مجموعة حفظ الأحداث والتنبيهات الخاصة بسورس ايسكو\n\n انضم لقناة السورس @isco",
                    megagroup=True,
                ),
            )
